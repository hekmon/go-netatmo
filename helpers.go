...
// Unfortunatly, Netatmo requires you to access it with POST, which can be annoying if you want to
// show/transmist your user a simple GET url: in that case, you can use the
// RetreiveUserRealAuthorizationURL() function in order to make the POST for you and retreive the
// real GET generated URL by the Netatmo servers. See step 1 of
